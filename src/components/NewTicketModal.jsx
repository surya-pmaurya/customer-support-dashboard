        ...
        <div className="fixed inset-0 z-[60]">
          ...
          <div className="relative z-10 flex min-h-full items-center justify-center p-4">
            <section
              ...
              className="w-full max-w-2xl rounded-2xl border border-white/10 bg-[#11141D] shadow-2xl"
            >
              <div className="flex items-start justify-between border-b border-white/10 p-5 sm:p-6">
                <div>
                  ...
                  <h2 id="new-ticket-title" className="mt-1 text-xl font-bold text-slate-50">
                    Create new ticket
                  </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 p-5 sm:p-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <label className="block">
                    <span className="text-sm font-medium text-slate-200">Customer email *</span>
                    <input
                      type="email"
                      name="customerEmail"
